// Cette component est pour remplir les champs necessaires de InfoSection dans la components Accueil

// data du premier contenu de la page Accueil
export const AcceuilContenuOne = {
    imgStart: '', 
    topLine: "", 
...
export const AcceuilContenuTwo = {
    imgStart: '', 
    topLine: "", 
